...
class InteractionLayer(nn.Module):
    ...
    def __init__(self, F, K, num_residual, activation_fn=None, rate=0.0,device='cpu'):
        ...
        # Dense layers
        self.k2f = DenseLayer(K, F,device=self.device)
        ...
        self.u = torch.ones([F], requires_grad=True, device=self.device,dtype=torch.float32)
